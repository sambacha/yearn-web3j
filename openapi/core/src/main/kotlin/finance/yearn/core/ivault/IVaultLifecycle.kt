...
interface IVaultLifecycle {

    @POST
    @Operation(
        tags = ["IVault Methods"],
        summary = "Deploys the IVault contract"
    )
    ...
    @Operation(
        tags = ["IVault Methods"],
        summary = "Loads the IVault contract"
    )
    fun load(
    ...
    @Operation(
        tags = ["IVault Methods"],
        summary = "Loads the IVault contract with predefined address"
    )
    fun load(): IVaultResource
}
